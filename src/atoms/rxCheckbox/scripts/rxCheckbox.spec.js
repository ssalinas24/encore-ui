describe('rxCheckbox', function () {
    ...
    describe('basic usage', function () {
        ...
        describe('parent', function () {
            ...
            it('should have "rxCheckbox" class', function () {
                expect(parent.attr('class')).to.contain('rxCheckbox');
            });
    ...
    describe('with "disabled" attribute', function () {
        beforeEach(function () {
            template = '<input rx-checkbox disabled>';
            el = helpers.createDirective(template, compile, scope);
        });
    ...
    describe('when "ng-disabled"', function () {
        beforeEach(function () {
            template = '<input rx-checkbox ng-disabled="isDisabled" />';
            el = helpers.createDirective(template, compile, scope);
        });
    ...
    describe('when destroyed', function () {
        ...
        beforeEach(function () {
            template = '<div><input rx-checkbox ng-if="isDisplayed" /></div>';
