...
exports.rxEnvironment = {
     ...
     * but should you find a need to supply your own environments, be sure to have <tt>environments</tt> defined in
     ...
     * under <tt>browser.params.environments</tt>.
     ...
     * environments by setting your own in your protractor configuration file as <tt>browser.params.environments</tt>.
     ...
     * @param {Boolean} [options.useBaseUrl=false] - Set this to <tt>true</tt> to not use the browser's current
     * environment when comparing, instead it will compare it to <tt>protractor.baseUrl</tt>.
     * @returns {Boolean}
     */
    ...
    /**
     * @private
     * @description <tt>options</tt> only supports { useBaseUrl: true }. If { useBaseUrl: false }, just leave undefined.
     */
