...
exports.rxMisc = {
     ...
     * @deprecated rxMisc.currencyToPennies will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.newDate will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.negate will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.nullValueMatches will be removed in EncoreUI 4.0.0
     * @example
     * var userPage {
     ...
     * @function
     * @deprecated rxMisc.unless will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.scrollPosition will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.compareYLocations will be removed in EncoreUI 4.0.0
     ...
     * @deprecated rxMisc.compareXLocations will be removed in EncoreUI 4.0.0
     ...
     * @private
     * @function
     * @deprecated rxMisc.transformLocation will be removed in EncoreUI 4.0.0
